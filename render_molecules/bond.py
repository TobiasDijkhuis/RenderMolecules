...
class Bond:
    ...
    def get_vdw_weighted_midpoints(self, element1: str, element2: str) -> np.ndarray:
        ...
        loc1 = self._midpointPosition - self.get_direction() * self._bond_length / (
            2 / fraction_vdw_radius1
        )
        loc2 = self._midpointPosition + self.get_direction() * self._bond_length / (
            2 / fraction_vdw_radius2
        )
